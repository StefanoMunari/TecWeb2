...
nell'utilizzo dei pulsanti (come spiegato in \ref{sezioni}). Risulta così oneroso
consultare e cercare le informazioni di cui l'utente necessita. Una possibile
soluzione consiste in:
\begin{itemize}
	\item eliminare le molte pagine di scroll, presenti nella maggior parte
delle sezioni, e creare delle sezioni 
a profondità maggiore rendendo l'attuale menù un menù a tendina (con due livelli di profondità sarebbe sufficiente);
...
\end{itemize}
    ...
    \caption{Menù ad un solo livello}
    \end{figure}
    \FloatBarrier 
Risultato : \textit{3.5}
\end{flushleft}