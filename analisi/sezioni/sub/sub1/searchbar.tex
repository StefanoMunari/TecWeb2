...
La barra di ricerca di un sito web dovrebbe permettere
...
L'interfaccia offerta dalla barra di ricerca (box testuale + pulsante search) 
...
di ricerca così particolare. Infatti anche chi conosce il sito potrebbe preferire
...
Quindi la lunghezza del box offerto da Alexa è accettabile, ma non ottimale.\\
Risultato : \textit{7.5} 