...
all'utente di raggiungere le sezioni che cerca diminuendo gli sforzi dati
dal dover navigare tramite menù all'interno del sito, rappresenta quindi 
...
\ref{overview} violando una tipica convenzione
del web. Probabilmente i creatori del sito assumono che chi lo visita 
...
Quindi la lunghezza del box offerto da Alexa è accettabile.\\
Risultato : \textbf{7.5} 